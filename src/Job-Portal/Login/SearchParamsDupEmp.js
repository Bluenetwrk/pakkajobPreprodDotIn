...
//   const [email, setEmail ] = useState("")  
  ...
  useEffect(()=>{
    ...
    await axios.post("/EmpProfile/loginforAdmin",{email})
    .then((res)=>{      
    //   console.log(res.data)
      ...
      let token = result.token
       ...
       if (result.status == "success") { 
          ...
          localStorage.setItem("EmpIdG", JSON.stringify(Id))
          navigate("/postedjobs", { state: { gserid: Id } })
...
export default SearchParamsDubEmp
